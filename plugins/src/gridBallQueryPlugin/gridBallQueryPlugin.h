...
#ifndef POINT_DETECTION_GRIDBALLQUERYPLUGIN_H
#define POINT_DETECTION_GRIDBALLQUERYPLUGIN_H
...
(                                                                                                                       \
    ...
    input(                                                                                                              \
        ...
        (float      , hash2subset   , dim(num_batch, num_hash))                                                         \
    ),                                                                                                                  \
    output(                                                                                                             \
...
#endif //POINT_DETECTION_GRIDBALLQUERYPLUGIN_H
