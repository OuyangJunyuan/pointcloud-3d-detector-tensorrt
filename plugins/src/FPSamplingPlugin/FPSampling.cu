...
void farthest_point_sampling_kernel_launcher(int b, int n, int m,
    ...
    switch (n_threads) {
        case 1024:
            farthest_point_sampling_kernel<1024><<<b, n_threads, 0, stream>>>(
                    b, n, m, xyz, temp, indices);
            break;
        case 512:
            farthest_point_sampling_kernel<
                    512><<<b, n_threads, 0, stream>>>(
                    b, n, m, xyz, temp, indices);
            break;
        case 256:
            farthest_point_sampling_kernel<
                    256><<<b, n_threads, 0, stream>>>(
                    b, n, m, xyz, temp, indices);
            break;
        case 128:
            farthest_point_sampling_kernel<
                    128><<<b, n_threads, 0, stream>>>(
                    b, n, m, xyz, temp, indices);
            break;
        case 64:
